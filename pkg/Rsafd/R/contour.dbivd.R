`contour.dbivd` <-
structure(function(dist, n = 50, xlim = NA, ylim = NA, ...)  standardGeneric("contour.dbivd"), 
generic = structure("contour.dbivd", package = ".GlobalEnv"), package = ".GlobalEnv", group = list(), 
